...
/* SDK spelling retained by later Dolphin/Revolution headers. */
#define GX_TG_MTX3x4 GX_TG_MTX3X4
#define GX_TG_MTX2x4 GX_TG_MTX2X4
#define GX_INDTEXSTAGE0 GX_IND_TEX_STAGE_0
#define GX_INDTEXSTAGE1 GX_IND_TEX_STAGE_1
#define GX_INDTEXSTAGE2 GX_IND_TEX_STAGE_2
#define GX_INDTEXSTAGE3 GX_IND_TEX_STAGE_3
#define GX_MAX_VTXDESC GX_VA_MAX_ATTR
#define GX_MAX_VTXDESCLIST_SZ (GX_MAX_VTXDESC + 1)
#define GX_MAX_VTXATTRFMT GX_VA_MAX_ATTR
#define GX_MAX_VTXATTRFMTLIST_SZ (GX_MAX_VTXATTRFMT + 1)
#define GX_MAX_TEVSTAGE GX_MAXTEVSTAGE
...
#define GX_FOG_LIN GX_FOG_LINEAR
#define GX_FOG_EXP GX_FOG_EXPONENT
#define GX_FOG_EXP2 GX_FOG_EXPONENT2
#define GX_FOG_REVEXP GX_FOG_REVERSEEXP
#define GX_FOG_REVEXP2 GX_FOG_REVERSEXP2
#define GX_BL_SRCCLR GX_BL_SRCCOL
#define GX_BL_INVSRCCLR GX_BL_INVSRCCOL
#define GX_BL_DSTCLR GX_BL_DSTCOL
#define GX_BL_INVDSTCLR GX_BL_INVDSTCOL
